		...
		return FunctionToolCallback.builder("list_table_schema", this)
			.description(
					"""
							...
							"queries" must contain **1–5 short, well-formed semantic questions or intent statements** that clearly express the business data need and corresponding Schema retrieval requirement.
							...
							## Parameters
							- queries (required): 1–5 semantic questions or intent statements.
							  These should reflect the business data context and the specific Schema information you aim to retrieve.
							- knowledge_base_ids (optional): limit the search scope to specified knowledge bases.
